...
/// <summary>
/// Represents HTTP content for JSON-RPC requests and responses with JSON serialization.
/// </summary>
public sealed class JsonRpcContent : HttpContent
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="JsonRpcContent"/> class for a JSON-RPC request.
    /// </summary>
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="JsonRpcContent"/> class for a JSON-RPC response.
    /// </summary>
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="JsonRpcContent"/> class.
    /// </summary>
    /// <param name="contentToSerialize">The content to serialize.</param>
    /// <param name="contentTypeInfo">The JSON type information for serialization.</param>
