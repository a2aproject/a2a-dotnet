...
public class A2A0001_0002_DiscriminatorAnalyzerTests
{
    ...
    public async Task Reports_Both_A2A0001_and_A2A0002_When_UnknownMissing_And_CountMissing_OnEnumIdentifierAsync()
    {
        ...
        var testInstance = new AnalyzerTest { TestCode = UsingsAndNamespace + test }.AsStrongNamedAssembly();
...
internal static class TestExtensions
{
    ...
    public static AnalyzerTest<TVerifier> AsStrongNamedAssembly<TVerifier>(this AnalyzerTest<TVerifier> test, string asmName = "AnalyzerTests.Generated", string? publicKey = null)
